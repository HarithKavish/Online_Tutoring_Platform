...
public abstract class Functions implements MaedMusicUI {
	public static void Search(Scanner sc,Statement st,String search) throws Exception {
    	System.out.println();
	...
	public static void Search(Scanner sc,Statement st,String a,String b) throws Exception {
    	System.out.println();
    	String query="Select song_name from songs where song_name like '%"+a+"%' and singers like '%"+b+"%'";
    	ResultSet rs = st.executeQuery(query);
    	int count=1;
    	while(rs.next()){
    		System.out.print(count+" :) ");
	...
	public static void Music(Scanner sc,Statement st) throws Exception{
        ...
        if(o==2) {
        	System.out.print("\n1 :) Search By Song Name\n2 :) Search By Song Name And Album\n\nChoose Your Option : ");
        	int q=sc.nextInt();
        	if(q==1) {
        		System.out.print("\nEnter Song Name : ");
